...
public:
	...
	inline
    cyg_count32 peek_base()                  // Get current count value
    {
        return m.peek_base();
    }
	
    inline
    cyg_count32 peek_size()                  // Get current count value
    {
        return m.peek_size();
    }

	inline
    void ** peek_itemqueue()                  // Get current count value
    {
        return m.peek_itemqueue();
    }

...
class Cyg_Interrupt
{
    ...
    static cyg_bool     DSRs_pending();
	                                    ...
	                                    // Check for in DSRs handler
    //static cyg_bool     DSR_processing();

	                                    // Check for in ISRs handler
    //static cyg_bool     ISR_processing();										
...
public:
        static cyg_bool                 bISR;              //bool:in ISR handler
        static cyg_bool                 bDSR;             //bool:in DSR handler
	...
	// -------------------------------------------------------------------------
	// Check for  DSRs processing

	static inline cyg_bool DSR_processing()
	{
		return (Cyg_Interrupt::bDSR == true);
	};
	// Check for  ISRs processing
	static inline cyg_bool ISR_processing()
	{
		return (Cyg_Interrupt::bISR == true);
	};	

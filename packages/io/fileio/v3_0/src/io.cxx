...
__externC int  diag_printf( const char *fmt, ... ); //CYGBLD_ATTRIB_PRINTF_FORMAT(1,2); 
...
//static int diag_printf( const char *fmt, ... ) CYGBLD_ATTRIB_PRINTF_FORMAT(1,2);
//extern int  diag_printf( const char *fmt, ... ) CYGBLD_ATTRIB_PRINTF_FORMAT(1,2); 

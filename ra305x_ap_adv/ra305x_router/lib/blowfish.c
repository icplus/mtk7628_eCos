...
// Blowfish algorithm
//
static void InitBlowfish (void);
	
static unsigned char key[MAXKEYBYTES];
...
static unsigned long F1(blf_ctx* bc,unsigned long x)
{
	unsigned short a;
	unsigned short b;
	unsigned short c;
...
static void Blowfish_encipher(blf_ctx *c,unsigned long *xl,unsigned long *xr)
{
	unsigned long Xl;
	unsigned long Xr; 
	unsigned long temp;
...
static void Blowfish_decipher(blf_ctx *c,unsigned long * xl, unsigned long *xr)
{
	unsigned long Xl;
	unsigned long Xr;
	unsigned long temp;
...
static void blf_enc(blf_ctx *c,unsigned long *data,int blocks){
	unsigned long *d;
	int i;
...
static void blf_dec(blf_ctx *c,unsigned long *data,int blocks){
	unsigned long *d;
	int i;

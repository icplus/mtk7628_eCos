 ...
 *
 * @(#)ipf.h	1.12 6/5/96
 * $Id: ipf.h,v 1.1 2010/01/28 11:09:57 dennis Exp $
 */
...
extern	int	hostmask __P((char ***, u_32_t *, u_32_t *, u_32_t *, u_short *, int *,
			      u_short *, int));
...
extern	char	*iphostname __P((int, void *));

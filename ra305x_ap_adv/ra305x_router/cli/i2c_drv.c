...
#else
#error "NOT define RALINK_I2C_BASE"
#endif /* CONFIG_MT7628_ASIC */


void do_udelay(unsigned int time)
{
	cyg_thread_delay(time/10); //以10ms为单位
}
...
#if 0
int rt2880_i2c_toolkit(cmd_tbl_t *cmdtp, int flag, int argc, char *argv[]) // main()
{
	int chk_match, size;
	ulong addr, value;
	u16 address;

...
(
	...
	"\t</specVersion>\r\n"
	"\t<device>\r\n"
	"\t\t<deviceType>urn:schemas-upnp-org:device:InternetGatewayDevice2WLAN:1</deviceType>\r\n"
...
int xml_InternetGatewayDevice2WLAN(UPNP_CONTEXT * context)
{
    int len;        	
	char url[128];
	char buf[255];
	...
	result = description_readXML(XML_INDEX_InternetGatewayDevice2WLAN,&pInternetGatewayDevice,&len);

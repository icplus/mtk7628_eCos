...
VOID RT635xATETssiCompensation(
	IN	PRTMP_ADAPTER	pAd)
{
	PATE_INFO pATEInfo = &(pAd->ate);
	ATE_CHIP_STRUCT *pChip = (pATEInfo->pChipStruct);
...
==========================================================================
*/
VOID RT635xATEAsicAdjustTxPower(
	IN PRTMP_ADAPTER pAd) 
{
	INT			i, j;
	CHAR 		Value;
/*	CHAR		Rssi = -127; */
	...
	RT635xATEAsicGetTxPowerOffset(pAd, (PULONG)&CfgOfTxPwrCtrlOverMAC);
#ifdef RTMP_TEMPERATURE_COMPENSATION
	/* Get temperature compensation delta power value */
	RT635xATEAsicGetAutoAgcOffsetForTemperatureSensor(
	...
	RT635xATEAsicCompensatePowerViaBBP(pAd, &TotalDeltaPower); /* MTK */

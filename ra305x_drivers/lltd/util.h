...
#define SSID_LEN(e)     (e)->SsidLength
//#endif /* HAVE_WIRELESS */
//snowpin--
...
#define ATTRIB_FORMAT_PRINTF __attribute__ ((format (diag_printf, 1, 2)))
...
extern void LLTD_DIE(const char *msg, ...) ATTRIB_FORMAT_PRINTF ATTRIB_NORETURN;
